      ...
      <div className="presentation-infoC">
        <div>
          ...
          <p className="desc-pres">
            ...
            Computacion y TI en la Universidad del Valle de Guatemala. Me
            apasiona estar probando cosas nuevas e investigar sobre lo que me
            llama la atencion, en especial cosas de tecnologia. Tengo todas las
            habilidades para crear nuevas herramientas de software. Actualmente
            me especializo en crear aplicaciones moviles y web.
          </p>
